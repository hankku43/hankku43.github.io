...
function ShowGopher(){
    ...
    const badGopherImg = gopher.querySelector('img[src="badgopher.png"]');
    const goodGopherImg = gopher.querySelector('img[src="goodgopher.png"]');
    const dizzyBadGopherImg = gopher.querySelector('img[src="dizzybadgopher.png"]');
    const dizzyGoodGopherImg = gopher.querySelector('img[src="dizzygoodgopher.png"]');
